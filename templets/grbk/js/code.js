...
{
	var funcs = "new continue if return default delete throw while typeof switch try typeof instanceof in if break do else for with catch import";
	var keywords =	'Math let Array slice split document window call bind apply push pop shift unshift concat forEach map reduce some render ' +
					'prototype Object __proto__ ' +
					'function Image add join ' +  
					'super getElementById getClassName const ' +
					'this var alert log'
					;
 	var datatypes =	'null true false';
	this.regexList = [
		{ regex: SyntaxHighlighter.regexLib.singleLineCComments,	css: 'comments' },			// one line comments
		{ regex: SyntaxHighlighter.regexLib.multiLineCComments,		css: 'comments' },			// multiline comments
		{ regex: SyntaxHighlighter.regexLib.doubleQuotedString,		css: 'string' },			// double quoted strings
		...
		{ regex: new RegExp(this.getKeywords(datatypes), 'gm'),		css: 'preprocessor' },	// datatypes
		{ regex: /[\=\+\-\/\$\|\%\@\<\>\*]|&amp;|&gt;|&lt;/gm,		css: 'color3' },
		{ regex: /[\(\)\{\}\.\;\,\[\]]/gm	,	css: 'variable' },	// datatypes
		{ regex: /\d+/gm,										css: 'preprocessor' },		// preprocessor tags like #region and #endregion
		];
	this.forHtmlScript(SyntaxHighlighter.regexLib.scriptScriptTags);
};
